...
export function openAddIndividualModal(loadIndividualClearances) {
    const formContent = `
        <form id="individualForm" class="space-y-4">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">OR # *</label>
    ...
    try {
        ...
        const content = `
            <div class="mb-4">
                ...
                <select id="signatorySelect" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    ${officialsOptions}
                </select>
            </div>
            <div id="outprint_modal">
                <div class="space-y-4 text-justify leading-relaxed">
                    ...
                    <p class="ml-8">ISSUED this <b><u class="px-1">${day}${getOrdinalSuffix(day)}</u></b> day of <b><u class="px-1">${month} ${year}</u></b> at ${fullLocation} upon request of the interested party for whatever legal purposes it may serve.</p>
                    <br>
                    <br>
                    <br>
                    <br>
                    <div class="flex justify-end">
                        <div class="w-1/3">
                            <div class="text-center border-b-2 border-black pb-1 signatory-name">${selectedOfficial.fullName}</div>
                            <div class="text-center signatory-position">${selectedOfficial.position}</div>
                        </div>
                    </div>
                    <br>
                    <dl class="row">
                        <dt class="col-auto font-medium">OR #:</dt>
                        <dd class="col-auto border-b border-black ml-2">${clearance.orNo}</dd>
                    </dl>
                    <dl class="row">
                        <dt class="col-auto font-medium">Date Issued:</dt>
                        <dd class="col-auto border-b border-black ml-2">${date.toLocaleDateString('en-US', { month: 'short', day: '2-digit', year: 'numeric' })}</dd>
                    </dl>
                </div>
