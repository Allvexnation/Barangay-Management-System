...
export function animateAuditLogs(selector = '#auditLogsContainer > div') {
    const logs = document.querySelectorAll(selector);
    staggerAnimate(logs, slideInLeft, 50);
}

export function initSystemInfoAnimations() {
    ...
    animateButtons('#save-btn, #reset-btn');
