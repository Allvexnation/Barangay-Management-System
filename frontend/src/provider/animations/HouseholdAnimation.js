...
export function initHouseholdAnimations() {
    animateHeader('h1, p.text-sm.text-gray-500');
    
    animateButtons('#exportHouseholdBtn, #printBtn, #addHouseholdBtn');
...
export function animateSearchInput(selector = '#householdSearch') {
