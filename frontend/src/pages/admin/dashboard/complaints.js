...
export async function renderComplaintsPage() {
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        <button 
                            ...
                            <span class="hidden sm:inline">File Complaint</span>
                        </button>
                    </div>
                </div>
...
function renderComplaintsTable() {
    ...
    tbody.innerHTML = filteredComplaints.map((complaint, index) => {
        ...
        return `
        <tr class="cursor-pointer" onclick="viewComplaint('${complaint.complaintId}')" style="transition: background-color 0.2s;" onmouseover="this.style.backgroundColor = document.documentElement.classList.contains('dark') ? 'rgba(255, 255, 255, 0.02)' : 'rgba(0, 0, 0, 0.1)'" onmouseout="this.style.backgroundColor = ''">
            <td class="px-3 sm:px-5 py-2 sm:py-3.5 text-xs text-gray-400 text-center font-mono">
                ${index + 1}
            </td>

            <td class="px-3 sm:px-5 py-2 sm:py-3.5">
                <p class="text-xs sm:text-sm font-semibold text-gray-900">${complaint.complainantName}</p>
            </td>
