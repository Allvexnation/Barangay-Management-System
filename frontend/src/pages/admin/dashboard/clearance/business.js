...
function renderBusinessTable() {
    ...
    tbody.innerHTML = filteredClearances.map((clearance, index) => {
        ...
        return `
        <tr class="cursor-pointer" onclick="viewBusinessClearance('${clearance.id}')" style="transition: background-color 0.2s;" onmouseover="this.style.backgroundColor = document.documentElement.classList.contains('dark') ? 'rgba(255, 255, 255, 0.02)' : 'rgba(0, 0, 0, 0.1)'" onmouseout="this.style.backgroundColor = ''">
